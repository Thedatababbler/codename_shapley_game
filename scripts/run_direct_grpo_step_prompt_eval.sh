#!/bin/bash
#SBATCH --job-name=direct_grpo_step_eval
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --time=08:00:00
#SBATCH --output=scripts/direct_grpo_step_eval-%j.out
#SBATCH --error=scripts/direct_grpo_step_eval-%j.err
#SBATCH --gpus=1
...
output_dir="${VERL_DIR}/outputs/direct_step_prompt_eval/${variant}_${SLURM_JOB_ID}"
...
if [[ ! -f "${actor_dir}/model_world_size_2_rank_0.pt" ]]; then
    "${PYTHON_BIN}" - <<PY
